...
import com.example.themoviedemo.api.MovieService
import com.example.themoviedemo.mappers.KeywordResponseMapper
import com.example.themoviedemo.mappers.ReviewResponseMapper
import com.example.themoviedemo.mappers.VideoResponseMapper
    ...
    fun loadKeywordList(id: Int): LiveData<Resource<List<Keyword>>> {
        return object: NetworkBoundRepository<List<Keyword>, KeywordListResponse, KeywordResponseMapper>() {
            ...
            override fun fetchService(): LiveData<ApiResponse<KeywordListResponse>> {
                ...
                Timber.e("amitt :: >> ${movieDao.toString()}")
